...
{
	if (ShooterOwnerCharacter == nullptr)
	{
		ShooterOwnerCharacter = Cast<AShooterCharacter>(GetOwner());
	}
	if (ShooterOwnerCharacter)
	{
		if (ShooterOwnerPlayerController == nullptr)
		{
			ShooterOwnerPlayerController = Cast<AShooterPlayerController>(ShooterOwnerCharacter->Controller);
		}
